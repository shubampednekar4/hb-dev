...
<div class="card">
    <header class="card-header card-header-danger">
        ...
        <p class="card-category">Add New Hb Ads To The System</p>
    </header>


    <section class="card-body">
    <?= $this->Form->create($hbad, ['enctype' => 'multipart/form-data']) ?>
    ...
    'type' => 'textarea',
        ...
        <div class="row">
        <div class="form-group col-md-6 col-sm-12">
        <?= $this->Form->control('image_location', [
    'class' => 'form-control',
    'label' => 'Image',
    'type' => 'file',
]); ?>
...
<div class="form-group col-md-6 col-sm-12">
<?= $this->Form->control('pdf_location', [
    'class' => 'form-control',
    'label' => 'Pdf',
    'type' => 'file',
]); ?>
